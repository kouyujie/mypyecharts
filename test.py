...
def app_1():  
    ...
    bar = Bar("每日任务量", "快修组",width=1910,height=1080,background_color='#fff')
    i = 1
    xx = []
    yy = []
    ...
    bar.add("审核量",xx,yy,mark_line=["average"], mark_point=["max", "min"],is_label_show = 1,label_pos = 'inside' )
    bar.add("修改量",xx1,yy1,mark_line=["average"], mark_point=["max", "min"],is_label_show = 1,label_pos = 'inside' )
